...
Project.create(project_name: "Schema Designer",
						   ...
						   project_stack: "Mongo Express React Redux Node",
							 ...
							 project_feature_lang: Tech.smart_find(title: 'React'),
							 project_state: "Stale Production",
							techs: [
								Tech.smart_find(title: 'React'),
								Tech.smart_find(title: 'Redux'),
								Tech.smart_find(title: 'Mongo'),
								Tech.smart_find(title: 'Express'),
								Tech.smart_find(title: 'Node'),
							])
...
Project.create(project_name: "Extra Print",
						   ...
						   project_stack: "Ruby",
							 ...
							 project_feature_lang: Tech.smart_find(title: 'Ruby'),
							 project_state: "Active Production",
							techs: [
								Tech.smart_find(title: 'Ruby'),
							])
...
Project.create(project_name: "BootCoder.net",
							 ...
							 project_feature_lang: Tech.smart_find(title: 'Ruby On Rails'),
							 project_state: "Active Production",
							techs: [
								Tech.smart_find(title: 'Ruby On Rails'),
								Tech.smart_find(title: 'JavaScript'),
								Tech.smart_find(title: 'jQuery'),
								Tech.smart_find(title: 'BootStrap'),
								Tech.smart_find(title: 'HTML'),
								Tech.smart_find(title: 'CSS'),
							])
...
Project.create(project_name: "TechLX",
							...
							techs: [
								...
								Tech.smart_find(title: 'JavaScript'),
								Tech.smart_find(title: 'jQuery'),
								Tech.smart_find(title: 'Stripe API'),
							])
...
Project.create(project_name: "MetaGame",
							...
							techs: [
								Tech.smart_find(title: 'Ruby On Rails'),
								Tech.smart_find(title: 'JavaScript'),
								Tech.smart_find(title: 'Ember'),
								Tech.smart_find(title: 'postgreSQL'),
								Tech.smart_find(title: 'BootStrap'),
								Tech.smart_find(title: 'HTML'),
								Tech.smart_find(title: 'GiantBomb-Steam API'),
							])
...
Project.create(project_name: "Qu-est",
						   ...
						   project_stack: "Ruby On Rails, Foundation CSS, JS, jQuery, postgreSQL",
							...
							techs: [
								Tech.smart_find(title: 'Ruby On Rails'),
								Tech.smart_find(title: 'Foundation CSS'),
								Tech.smart_find(title: 'JavaScript'),
								Tech.smart_find(title: 'jQuery'),
								Tech.smart_find(title: 'postgreSQL'),
							])
...
Project.create(project_name: "DBCode",
							 ...
							 project_feature_lang: Tech.smart_find(title: 'Sinatra'),
							 project_state: "Beta",
							techs: [
								Tech.smart_find(title: 'Sinatra'),
								Tech.smart_find(title: 'Ruby'),
								Tech.smart_find(title: 'Javascript'),
								Tech.smart_find(title: 'HTML'),
								Tech.smart_find(title: 'CSS'),
								Tech.smart_find(title: 'oAuth'),
								Tech.smart_find(title: 'BootStrap'),
							])
...
Project.create(project_name: "DoppelTwit",
							...
							techs: [
								Tech.smart_find(title: 'Sinatra'),
								Tech.smart_find(title: 'Ruby'),
								Tech.smart_find(title: 'SQL'),
								Tech.smart_find(title: 'Basic Auth'),
								Tech.smart_find(title: 'Active Record'),
							])
...
Project.create(project_name: "HomeBase",
							...
							techs: [
								Tech.smart_find(title: 'Sinatra'),
								Tech.smart_find(title: 'Ruby'),
								Tech.smart_find(title: 'Skeleton'),
								Tech.smart_find(title: 'HTML'),
								Tech.smart_find(title: 'CSS'),
								Tech.smart_find(title: 'Javascript'),
								Tech.smart_find(title: 'AJAX'),
							])
